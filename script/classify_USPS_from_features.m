...
% (3) ISOMAP
[mappedX_isomap, mapping_isomap] = isomap(Y', dx, 30);
subplot(223); scatter(mappedX_isomap(:,1), mappedX_isomap(:,2), 20, true_label(mapping_isomap.conn_comp), 'o', 'filled');
title('isomap');

% (4) LLE
[mappedX_lle, mapping_lle] = lle(Y', dx, 40);
